...
| [
    ...
    "<div class=\"section-heading nip46-heading\"><div><h2>See NIP-46 <em>in motion.</em></h2></div><p>Create a disposable test client, pair it with Signstr, and watch an encrypted public-key request make the round trip through Nostr relays.</p></div>",
    ...
    "<div class=\"tester-toolbar\"><div class=\"tester-live-status\"><span class=\"tester-status-dot\" id=\"nip46-status-dot\"></span><div class=\"tester-status-copy\" aria-live=\"polite\"><strong id=\"nip46-status-text\">Ready to begin</strong><code id=\"nip46-status-npub\" hidden></code></div></div><div class=\"tester-meta\"><span>Expires <strong id=\"nip46-countdown\">—</strong></span><button id=\"nip46-reset\" type=\"button\">Reset</button></div></div>",
    "<div class=\"tester-grid\" id=\"nip46-pairing-content\">",
